...
(
		...
		opp_deposit_ratio_type		VARCHAR2(20),
		opp_deposit_rate			VARCHAR2(20),
		opp_deposit_balance			VARCHAR2(20),
...
comment on column exch.open_close_flag is
'[0-闭市; 1-开市]';
